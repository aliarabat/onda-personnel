			...
			if (theWork == null) {
				...
				if (theDay == null) {
					...
					if (theDay.getVacation() != null) {
						...
						if (thedayDetail.getReplacement() != null || thedayDetail.getSkip() != null
								|| thedayDetail.getMission() != null) {
							return -2;
						} else {
...
//                                
						...
						if (i == 0) {
							...
							if (thedayDetail.getReplacement() != null || thedayDetail.getSkip() != null
								...
								Replacement checkReplacement = replacementService.createReplacement(matricule,
										matricule1, detail.getWording(), replacement);
